...
public class AddBug {
	...
	public void addBug(ObjectOutputStream out, ObjectInputStream in, Employee employee, String fileName, Bug bug,
			String bugFile) throws ClassNotFoundException, IOException {
		do {
